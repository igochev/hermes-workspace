  ...
  it('auto-launches Builder for a ready build work item with an accepted plan', async () => {
    ...
    launchWorkItemIntoConductor.mockResolvedValue({
      workItem: {
        ...
        status: 'active',
        phase: 'build',
        missionId: 'execution-builder-1',
        missionLink: '/executions/execution-builder-1',
        missionState: 'running',
      },
      launch: {
        executionRunId: 'execution-builder-1',
        sessionKey: 'session-builder-1',
        state: 'running',
        link: '/executions/execution-builder-1',
        phase: 'build',
      },
    })
    ...
    expect(result.events).toMatchObject([
      {
        ...
        jobId: 'execution-builder-1',
        runId: 'execution-builder-1',
        statusAfter: 'active',
        phaseAfter: 'build',
      },
    ])
